...
public class EmpruntService {
    ...
    public String addEmprunt(Emprunt emprunt, List<String> NIs) throws SQLException {
        List<Long> ids=new ArrayList<>();
        for (String NI : NIs){
            Livre livre=livreRepository.findNumInventaire(NI);
        ...
        Emprunteur emprunteur=emprunteurRepository.findByMembreShip(emprunt.getEmprunteur().getMembership());
        if(emprunteur!=null) {
